...
class _Split(Enum):
    ...
    def get_image_relpath(self, actual_index: int, class_id: Optional[str] = None) -> str:
        ...
        return os.path.join(dirname, f"{actual_index}" + ".jpg")
...
class ImageShipID_10000I(ExtendedVisionDataset):
    ...
    def __init__(
        self,
        *,
        split: "ImageShipID_10000I.Split",
        root: str,
        extra: str,
    ...
    @property
    def split(self) -> "ImageShipID_10000I.Split":
        return self._split
    ...
    def _dump_entries(self) -> None:
        split = self.split
        if split == ImageShipID_10000I.Split.TEST:
            dataset = None
